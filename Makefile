# This Makefile is for the Memoize::Class::Constructor extension to perl.
#
...
NAME_SYM = Memoize_Class_Constructor
VERSION = v0.01
...
MAKE = make
FULLEXT = Memoize/Class/Constructor
BASEEXT = Constructor
PARENT_NAME = Memoize::Class
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Memoize/Class/Constructor.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Memoize/Class/Constructor.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Memoize/Class
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Memoize/Class
...
TO_INST_PM = lib/Memoize/Class/Constructor.pm

PM_TO_BLIB = lib/Memoize/Class/Constructor.pm \
	blib/lib/Memoize/Class/Constructor.pm
...
DISTNAME = Memoize-Class-Constructor
DISTVNAME = Memoize-Class-Constructor-v0.01
...
manifypods : pure_all  \
	lib/Memoize/Class/Constructor.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Memoize/Class/Constructor.pm $(INST_MAN3DIR)/Memoize::Class::Constructor.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Memoize/Class/Constructor.pm blib/lib/Memoize/Class/Constructor.pm 
